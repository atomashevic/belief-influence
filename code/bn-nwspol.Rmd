...
5.  Empty model, equal mean structure`model_3`
6.  Sparse model, equal mean structure `model_3b`
7.  Empty model, equal temperature `model_4`
8.  Sparse model, equal temperature `model_4b`
...
model_3 <- model_1 %>% groupequal("mu") %>% runmodel
...
model_4 <- model_1 %>% groupequal("delta") %>% runmodel
...
comparison <- compare(
    ...
    `5. equal means (empty)` = model_3,
    `6. equal means (sparse)` = model_3b,
    `7. equal temperature (empty)` = model_4,
    `8. equal temperature (sparse)` = model_4b) %>% arrange(BIC) 
