...
\begin{enumerate}
	\item Whole network plot after UVA
	\item IVI plot on whole network
	\item Differences in network structure, ROW, Class
	\item Differences in IVI -> Three countries, spyder-plot
	\item Differences in IVI -> ROW, spyder-plot
	\item Stacked barplots for IVI Country, ROW, Class
